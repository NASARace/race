...
/**
  ...
  */
class AsdexMsgParserBuffered(val config: Config=NoConfig)
  extends BufferedASCIIStringXmlPullParser2(config.getIntOrElse("buffer-size",100000)) with ConfigurableTranslator {
...
/**
  ...
  * is available
  */
class FullAsdexMsgParserBuffered(_config: Config=NoConfig) extends AsdexMsgParserBuffered(_config) {
...
/**
  ...
  */
class GlobalFullAsdexMsgParserBuffered(_config: Config=NoConfig) extends FullAsdexMsgParserBuffered(_config) {
