...
/**
  ...
  */
class MessageCollectionParserBuffered(val config: Config=NoConfig)
             extends BufferedASCIIStringXmlPullParser2(config.getIntOrElse("buffer-size",150000)) with ConfigurableTranslator {
