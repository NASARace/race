...
import gov.nasa.race.common.{ASCIIStringXmlPullParser2, Rev, Src, StringXmlPullParser2}
...
class TATrackAndFlightPlanParser (val config: Config=NoConfig)
  extends ASCIIStringXmlPullParser2(config.getIntOrElse("buffer-size",100000)) with ConfigurableTranslator {
