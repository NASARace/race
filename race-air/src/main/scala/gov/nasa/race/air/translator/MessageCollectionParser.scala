...
class MessageCollectionParser(val config: Config=NoConfig) extends UTF8XmlPullParser2
  ...
  val nasFlight = ConstAsciiSlice("ns5:NasFlight")
  ...
  val actualSpeed = ConstAsciiSlice("actualSpeed")
  val uom = ConstAsciiSlice("uom")
  val knots = ConstAsciiSlice("KNOTS")
  val mph = ConstAsciiSlice("MPH")
  val kmh = ConstAsciiSlice("KMH")
  val feet = ConstAsciiSlice("FEET")
  val meters = ConstAsciiSlice("METERS")
  val arrival = ConstAsciiSlice("arrival")
  val arrivalPoint = ConstAsciiSlice("arrivalPoint")
  val time = ConstAsciiSlice("time")
  val centre = ConstAsciiSlice("centre")
  ...
  protected def parseFlight: Unit = {
    ...
    def flight (data: Array[Byte], off: Int, len: Int): Unit = {
      if (isStartTag) {
        ...
        def readSpeed: Speed = {
          val u = if (parseAttr(uom)) attrValue else ConstUtf8Slice.EmptySlice
