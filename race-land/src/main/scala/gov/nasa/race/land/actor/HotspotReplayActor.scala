...
/**
  ...
  * Note this is not corresponding to live import since the satellites have polar orbits and we only get
  * two intervals per day where they can observe areas of interest
  *
