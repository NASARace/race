...
<div class="run">1: ./race config/net/share-coordinator.conf</div><a class="srv" href="http://localhost:8000/share" target="_blank"></a>

<div class="run">2: ./race config/net/share-node_1.conf</div><a class="srv" href="http://localhost:8001/share" target="_blank"></a>

<div class="run">3: ./race config/net/share-node_2.conf</div><a class="srv" href="http://localhost:8002/share" target="_blank"></a>
