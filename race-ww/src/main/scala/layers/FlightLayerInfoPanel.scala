...
import gov.nasa.race.common.{DateTimeUtils, StringUtils}
import gov.nasa.race.data._
import gov.nasa.race.data.InFlightAircraft
import gov.nasa.race.data.filters.FlightQueryFilter
import gov.nasa.race.swing.GBPanel._
import gov.nasa.race.swing.Style._
import gov.nasa.race.swing.{Filler, GBPanel, ItemRenderPanel, ListItemRenderer, SelectionPreserving, Separator, Style, VisibilityBounding}
import gov.nasa.race.ww._
import org.joda.time.DateTime

import scala.swing.Swing._
import scala.swing.event._
import scala.swing.{Action, BoxPanel, Button, ButtonGroup, CheckBox, FlowPanel, Label, ListView, MenuItem, Orientation, PopupMenu, RadioButton, ScrollPane, TextField}
...
class FlightLayerInfoPanel[T <: InFlightAircraft](raceView: RaceView, flightLayer: FlightLayer[T])
  ...
  class MatchRenderer extends ItemRenderPanel[FlightEntry[T]] {
    ...
    def configure(list: ListView[_], isSelected: Boolean, focused: Boolean, e: FlightEntry[T], index: Int) = {
      ...
      val hdg = normalize(obj.heading).toDegrees.toInt
