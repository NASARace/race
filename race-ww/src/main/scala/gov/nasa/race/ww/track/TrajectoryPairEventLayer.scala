...
/**
  ...
  */
class TrajectoryPairEventLayer (val raceViewer: RaceViewer, val config: Config) extends TrackLayer[TrajectoryPairEvent] {
  override def queryLocation(id: String): Option[GeoPositioned] = ???
}
